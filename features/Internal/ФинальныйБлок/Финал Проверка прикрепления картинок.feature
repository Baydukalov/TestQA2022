...
Сценарий: Прикрепления файла картинки
	...
	И я делаю 2 раз
		...
		И я запоминаю значение выражения '"_ТестКартинки_" + $СуффиксНаименования$'  в переменную "Наименование"
		...
		//Не пойму, не воспроизводит действия по выбору файла, приходится руками записывать						
		//И я нажимаю на кнопку с именем "Открыть"
		//Тогда открылось окно '$НаименованиеОкнаФайла$'
		И я жду появления файла '$ИмяФайла$' в течение 20 секунд	
